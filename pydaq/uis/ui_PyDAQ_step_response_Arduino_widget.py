...
"")
        ...
        self.gridLayout_2.addWidget(self.label_12, 7, 0, 1, 1, Qt.AlignmentFlag.AlignVCenter)
        ...
        self.device_combo.setMaximumSize(QSize(16777215, 16777215))
        ...
        self.gridLayout_2.addWidget(self.line_2, 0, 2, 8, 1)
        ...
        self.gridLayout_2.addWidget(self.widget_16, 7, 3, 1, 1)
        ...
        self.yes_pid_radio = QRadioButton(self.widget_2)
        self.parameters_radio_group = QButtonGroup(Arduino_StepResponse_W)
        self.parameters_radio_group.setObjectName(u"parameters_radio_group")
        self.parameters_radio_group.addButton(self.yes_pid_radio)
        self.yes_pid_radio.setObjectName(u"yes_pid_radio")
        self.yes_pid_radio.setChecked(False)

        self.horizontalLayout.addWidget(self.yes_pid_radio)

        self.no_pid_radio = QRadioButton(self.widget_2)
        self.parameters_radio_group.addButton(self.no_pid_radio)
        self.no_pid_radio.setObjectName(u"no_pid_radio")
        self.no_pid_radio.setChecked(True)
