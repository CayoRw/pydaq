...
################################################################################
## Form generated from reading UI file 'PyDAQ_pid_control_window_dialog_testuJLdNC.ui'
##
...
class Ui_Dialog_Plot_PID_Window_Test(object):
    def setupUi(self, Dialog_Plot_PID_Window_Test):
        if not Dialog_Plot_PID_Window_Test.objectName():
            Dialog_Plot_PID_Window_Test.setObjectName(u"Dialog_Plot_PID_Window_Test")
        Dialog_Plot_PID_Window_Test.resize(510, 602)
        Dialog_Plot_PID_Window_Test.setStyleSheet(u"QWidget{\n"
...
"\n"
"")
        self.verticalLayout = QVBoxLayout(Dialog_Plot_PID_Window_Test)
        self.verticalLayout.setObjectName(u"verticalLayout")
        self.widget = QWidget(Dialog_Plot_PID_Window_Test)
...
"")
        ...
        self.retranslateUi(Dialog_Plot_PID_Window_Test)

        QMetaObject.connectSlotsByName(Dialog_Plot_PID_Window_Test)
    # setupUi

    def retranslateUi(self, Dialog_Plot_PID_Window_Test):
        Dialog_Plot_PID_Window_Test.setWindowTitle(QCoreApplication.translate("Dialog_Plot_PID_Window_Test", u"Dialog", None))
#if QT_CONFIG(tooltip)
        self.label_Type.setToolTip(QCoreApplication.translate("Dialog_Plot_PID_Window_Test", u"<html><head/><body><p><img src=\":/imgs/imgs/PID_Flow.png\"/></p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.label_Type.setText(QCoreApplication.translate("Dialog_Plot_PID_Window_Test", u"Controler type?", None))
        self.label_Kd.setText(QCoreApplication.translate("Dialog_Plot_PID_Window_Test", u"Kd:", None))
        self.comboBox_TypeDialog.setItemText(0, QCoreApplication.translate("Dialog_Plot_PID_Window_Test", u"P", None))
        self.comboBox_TypeDialog.setItemText(1, QCoreApplication.translate("Dialog_Plot_PID_Window_Test", u"PI", None))
        self.comboBox_TypeDialog.setItemText(2, QCoreApplication.translate("Dialog_Plot_PID_Window_Test", u"PD", None))
        self.comboBox_TypeDialog.setItemText(3, QCoreApplication.translate("Dialog_Plot_PID_Window_Test", u"PID", None))

        self.label_Ki.setText(QCoreApplication.translate("Dialog_Plot_PID_Window_Test", u"Ki:", None))
        self.label_Setpoint.setText(QCoreApplication.translate("Dialog_Plot_PID_Window_Test", u"Setpoint:", None))
        self.label_Kp.setText(QCoreApplication.translate("Dialog_Plot_PID_Window_Test", u"Kp:", None))
#if QT_CONFIG(tooltip)
        self.label_Disturbe.setToolTip(QCoreApplication.translate("Dialog_Plot_PID_Window_Test", u"<html><head/><body><p><span style=\" font-size:14pt;\">The disturbance will be added as an integrator to the output signal of the PID control, as shown in the figure below:</span></p><p><img src=\":/imgs/imgs/PID_Flow.png\"/></p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.label_Disturbe.setText(QCoreApplication.translate("Dialog_Plot_PID_Window_Test", u"Disturbe:", None))
#if QT_CONFIG(tooltip)
        self.label_I_Distrube.setToolTip(QCoreApplication.translate("Dialog_Plot_PID_Window_Test", u"<html><head/><body><p><span style=\" font-size:14pt;\">The disturbance will be added as an integrator to the output signal of the PID control, as shown in the figure below:<br/></span><img src=\":/imgs/imgs/PID_Flow.png\"/></p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.label_I_Distrube.setText(QCoreApplication.translate("Dialog_Plot_PID_Window_Test", u"<html><head/><body><p><img src=\":/imgs/imgs/inform.png\"/></p></body></html>", None))
#if QT_CONFIG(tooltip)
        self.label_i_Type.setToolTip(QCoreApplication.translate("Dialog_Plot_PID_Window_Test", u"<html><head/><body><p><img src=\":/imgs/imgs/PID_Flow.png\"/></p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.label_i_Type.setText(QCoreApplication.translate("Dialog_Plot_PID_Window_Test", u"<html><head/><body><p><img src=\":/imgs/imgs/inform.png\"/></p></body></html>", None))
        self.pushButton_apply.setText(QCoreApplication.translate("Dialog_Plot_PID_Window_Test", u"Apply", None))
        self.pushButton_startstop.setText(QCoreApplication.translate("Dialog_Plot_PID_Window_Test", u"Stop", None))
        self.pushButton_close.setText(QCoreApplication.translate("Dialog_Plot_PID_Window_Test", u"Close", None))
    # retranslateUi
