...
################################################################################
## Form generated from reading UI file 'PyDAQ_send_data_Arduino_widgetsejodk.ui'
##
...
class Ui_Arduino_SendData_W(object):
    def setupUi(self, Arduino_SendData_W):
        ...
        Arduino_SendData_W.resize(438, 266)
...
"}")
    ...
    def retranslateUi(self, Arduino_SendData_W):
        ...
        self.label_8.setText(QCoreApplication.translate("Arduino_SendData_W", u"Data path:", None))
        ...
        self.label.setText(QCoreApplication.translate("Arduino_SendData_W", u"Arduino:", None))
