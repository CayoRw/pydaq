...
################################################################################
## Form generated from reading UI file 'PyDAQ_BaselVxITq.ui'
##
...
"")
        ...
        self.scrollAreaWidgetContents_6.setGeometry(QRect(0, 0, 503, 402))
        ...
        self.scrollAreaWidgetContents_7.setGeometry(QRect(0, 0, 503, 402))
        ...
        self.scrollAreaWidgetContents_11.setGeometry(QRect(0, 0, 503, 402))
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QRect(0, 0, 503, 402))
        ...
        self.scrollAreaWidgetContents_4.setGeometry(QRect(0, 0, 503, 402))
        ...
        self.scrollAreaWidgetContents_5.setGeometry(QRect(0, 0, 503, 402))
        ...
        self.scrollAreaWidgetContents_3.setGeometry(QRect(0, 0, 503, 402))
        ...
        self.nidaq_tabs.addTab(self.tab_2, "")
    ...
    def retranslateUi(self, PydaqGlobal):
        ...
        self.arduino_tabs.setTabText(self.arduino_tabs.indexOf(self.step_response_arduino_tab), QCoreApplication.translate("PydaqGlobal", u"Step Respons", None))
        ...
        self.nidaq_tabs.setTabText(self.nidaq_tabs.indexOf(self.tab_2), QCoreApplication.translate("PydaqGlobal", u"PID Control", None))
    # retranslateUi
