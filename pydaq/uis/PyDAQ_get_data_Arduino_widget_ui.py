...
################################################################################
## Form generated from reading UI file 'PyDAQ_get_data_Arduino_widget.ui'
##
...
class Ui_Arduino_GetData_W(object):
    def setupUi(self, Arduino_GetData_W):
        ...
        Arduino_GetData_W.resize(543, 354)
...
"}")
        ...
        self.gridLayout.addWidget(self.widget_8, 4, 2, 1, 1, Qt.AlignmentFlag.AlignLeft)
